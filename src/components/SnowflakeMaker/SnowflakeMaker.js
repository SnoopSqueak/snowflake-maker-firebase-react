...
class SnowflakeMaker extends Component {
  ...
  render () {
    return (
      <div>
        <div id="container">
          <SnowflakeCanvas colorIndex={this.state.index} linkState={this.props.location.state} provider={this.props.provider} firebase={this.props.firebase} gradientBackground={this.state.gradient} color={this.state.color} bgColors={bgColors} bgColor={bgColors[this.state.index]} setIndex={this.setIndex.bind(this)} />
        </div>
        <div id="container2">
          <SavePanel />
        </div>
