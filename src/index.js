...
// nearly all of the code beyond this point was borrowed (for educational purposes) from http://rectangleworld.com/PaperSnowflake/
window.addEventListener("load", windowLoadHandler, false);
var bgColors, shareTextArea;
const titleText = document.getElementById("titleText");
const urlText = document.getElementById("urlText");
const urlText2 = document.getElementById("urlText2");
...
function canvasApp() {
	...
	//(hey look, even the code I lifted lifted code)
...
// this part came from create-react-app
